...
Furthermore, as mentioned earlier, community projects like the Fortran-lang standard library ([stdlib](https://github.com/fortran-lang/stdlib)), the Fortran Package Manager ([fpm](https://github.com/fortran-lang/fpm)), and the LLVM-based compiler [LFortran](https://github.com/lfortran/lfortran) address the need for modern tools that Fortran was previously lacking.
