...
- There are several advantages to `pure` procedures. It keeps all the "work" (mathematical calculations) in smaller, more understandable procedures. These procedures have no side effect and can therefore be easily used in `do concurrent` loops or 'manually' parallelised.
...
::: {.column width="85%"}
There is no reason to mention Herbert in this post other than the fact he is acknowledged in the *JOSS* paper [@mutz:2025] and relevant to everything in my life. He is -- by far -- the smartest, proudest, and most glorious pigeon I've ever had the privilege of knowing, and his fame is ever-increasing.
