...
::: {.column width="85%"}
PyESD is an open-source framework for empirical-statistical downscaling of any climate-related variable such as precipitation, temperature, and wind speed. The package can, for example, downscale General Circulation Model simulations of future climate to high resolution relevant for climate impact assessment such as droughts, flooding, wildfire risk, and others. The package was developed by **Dr. Daniel Boateng** as a PhD student and under supervision of Dr. Sebastian G. Mutz. pyESD's publication in *Geoscientific Model Development* can be accessed [here](https://doi.org/10.5194/gmd-16-6479-2023).
...
![Typical workflow for using pyESD to downscale climate data before it is used for impact modelling [Boatend and Mutz, 2023](https://doi.org/10.5194/gmd-16-6479-2023).](img/pyESD_outline.png){ width=100% }
...
Boateng, D. and Mutz, S. G.: pyESDv1.0.1: an open-source Python framework for empirical-statistical downscaling of climate information, Geosci. Model Dev., 16, 6479–6514, https://doi.org/10.5194/gmd-16-6479-2023, 2023.
